...
# ---------------------------------------------------------------------------- #
_C.SOLVER.STAGE3 = CN()
_C.SOLVER.STAGE3.IMS_PER_BATCH = 3
_C.SOLVER.STAGE3.OPTIMIZER_NAME = "Adam"
_C.SOLVER.STAGE3.BASE_LR = 0.0002
_C.SOLVER.STAGE3.MAX_EPOCHS = 200
_C.SOLVER.STAGE3.CHECKPOINT_PERIOD = 100
...
_C.TEST.EVAL = False
# is to test the weather dataset?
_C.TEST.WEATHER = 'no'
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
