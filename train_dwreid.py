...
from datasets.make_dataloader_dwreid import make_dataloader
from model.make_model_dwreid import make_model
from solver.make_optimizer_prompt import make_optimizer_1stage, make_optimizer_2stage
from solver.scheduler_factory import create_scheduler
from solver.lr_scheduler import WarmupMultiStepLR
from loss.make_loss import make_loss
from processor.processor_dwreid_stage1 import do_train_stage1
from processor.processor_dwreid_stage2 import do_train_stage2
import random
import torch
import numpy as np
import argparse
...
if __name__ == '__main__':
    # from threestage.train_dwreid import do_train
    # do_train()
    # print('3stage train is over!!!!')

    parser = argparse.ArgumentParser(description="ReID Baseline Training")
    parser.add_argument(
        "--config_file", default="configs/person/vit_dwreid.yml", help="path to config file", type=str
    )
    ...
    optimizer_2stage, optimizer_center_2stage,optimizer_weather_2stage = make_optimizer_2stage(cfg, model, center_criterion)
